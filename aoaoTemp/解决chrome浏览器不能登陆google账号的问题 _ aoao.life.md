---
title: 解决chrome浏览器不能登陆google账号的问题 | aoao.life
date: 2014-10-31 09:57:16
...
接下来我们只需要对这个扩展进行简单的配置：具体方法请自行google。（什么？你说你还没有配置好不能上google，请选择<http://wen.lu）,在全局模式下再次登陆chrome的google账号，于是：>
...
如果你看完这篇还有疑问，请评论。如没有及时回复，请到新浪微博@继续aoao.life 找我。
...
在这里，用到了jinjia2作为PC端商城的渲染引擎。它有点像是Django的模板引擎，总体来说，使用起来比较简单。另外，使用[tasktiger](%5Bhttps://github.com/closeio/tasktiger%5D(https://github.com/closeio/tasktiger))作为任务队列（消息队列）的处理引擎。使用ELK 进行日志监控和错误筛选。将项目部署到git私有服务器  

---
title: 一个YouTube视频搬运工的教训 | aoao.life
...
首先，通过node爬虫，模拟浏览器的访问，获取到Ｂ站某个up主的所有视频，接下来通过node的child\_process来执行[you-get](https://github.com/soimort/you-get) 的命令行命令，使得这个up主的视频能够批量地被下载下来。当然，我并不想竭泽而渔，也觉得老视频没有多少意义，所以每个up主，我最多只爬去最新的100个视频。

---
title: 使用腾讯云存储及CDN的实践经验总结 | aoao.life
...
|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` localPath=/opt/demo/var/buckets  exeludes=/opt/demo/var/buckets/log;/opt/ljmall-public--2/var/buckets/invoice ``` |
...
|  |  |
| --- | --- |
| ``` 1 ``` | ``` bucketname-appid.cos.region-code.myqcloud.com/key ``` |

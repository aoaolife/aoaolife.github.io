...
|  |  |
| --- | --- |
| ``` 1 2 3 4 5 6 7 8 ``` | ``` if(clip.GetActiveApp() == "forticlient.exe") { 	auto text = clip.GetAsciiString(); 	clip.SetAsciiString("password"+text); }  return false ``` |

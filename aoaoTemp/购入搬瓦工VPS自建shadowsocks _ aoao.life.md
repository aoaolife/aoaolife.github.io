---
title: 购入搬瓦工VPS自建shadowsocks | aoao.life
date: 2015-01-09 21:58:16
...
后来参考了<https://github.com/kellyschurz/oneclicktoss> 这个一键配置shadoowsocks的使用方法，在本地下载了putty并且参考这个教程 <http://www.tennfy.com/2022.html> 学会了使用该软件，中间有一些曲折，不过最后结合这两个资料成功配置了ss。
